...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveBitmapToFile(final Bitmap bitmap, final int position) throws Exception {
       ...
       // {":"United States","State":"Alaska","remindBefore":"0","":"","":"","DL_front_PicPath":"\/Owner\/Provider\/DL\/HPzKnSHyEQk0RWxr73yTBQ==\/DL_front_2020092510243798868.png","DL_back_PicPath":"\/Owner\/Provider\/DL\/HPzKnSHyEQk0RWxr73yTBQ==\/DL_back_2020092510243798868.png"}

       String SessionToken =  "keaenkx7SLxKQE8CGom1B3uOeJbvrLd3KLa7cGpY+sYs16\/u3PeyO1kDnrvEA9+OTIOqOojiiA\/1JCJk2NtU6sIpHI5sLtHvg06OCaITemUKWnj8KRViBJ0ry2ou+sfCz5z7GXDmMYSdIpQ08NGFMxibrqtIVYL70kPUtC8fYeA=";

        String UserId  = "Pfyy0NefR7hbLSzDhf9s5m+dX0XhyGQct7IESPea600=";

        String dlNumber  = "0";

        String issuedDate  = "09-01-2020";
        String expiryDate  = "09-17-2020";
        ...
        Call<ServerResponse> call = getResponse.uploadFile(SessionToken,UserId,dlNumber,issuedDate,
                expiryDate,Country,State,"","");
